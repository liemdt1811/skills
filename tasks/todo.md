...
- [x] Create `package.json` with `bin` definition for `npx install-skills` <!-- id: 0 -->
- [x] Create `bin/install.js` script to copy `skills` to targets (Claude, Codex, Antigravity) <!-- id: 1 -->
